...
// }
  ...
  //     if (heatMapState is GetStartDateLoading) {
  //       return Center(child: CircularProgressIndicator());
  //     }
  //     if (heatMapState is GetStartDateError) {
  //       return Text(heatMapState.errMessage);
  //     }
  //     if (heatMapState is GetStartDateLoaded) {
  //       return CustomHeatmap(
  //         startDate: DateTime.now(),
  //         datasets: prepHeatMapDataset(state.habits),
  //       );
  //     }
  //     return SizedBox();
  //   },
